...
const CARDS: CultureCard[] = [
  {
    ...
    title:  { en: 'Greeting & Handshakes',   ru: 'Приветствие и рукопожатия' },
    intro:  { en: 'Greetings are a serious social ritual in Kyrgyzstan — always take a moment to greet everyone individually.',
              ru: 'Приветствие — важный ритуал в Кыргызстане: всегда уделите время, чтобы поздороваться с каждым.' },
    tips: [
      { en: 'Men greet each other with a firm handshake, often clasping with both hands for close friends.',
        ru: 'Мужчины здороваются крепким рукопожатием; с близкими — берут руку двумя ладонями.' },
      { en: 'Say "Salamatsyzby" (formal) or "Salam" (casual, with friends).',
        ru: 'Говорите "Саламатсызбы" (официально) или "Салам" (неформально, с друзьями).' },
      { en: 'When entering a room, greet every person — skipping someone is considered rude.',
        ru: 'Входя в комнату, поздоровайтесь с каждым — пропустить кого-то считается невежливым.' },
      { en: 'Sustained eye contact during greeting is a sign of respect and honesty.',
        ru: 'Зрительный контакт при приветствии — знак уважения и честности.' },
    ],
  ...
  },
  {
    ...
    intro:  { en: 'Removing shoes before entering any home is an absolute rule — no exceptions.',
              ru: 'Снять обувь перед входом в дом — абсолютное правило без исключений.' },
    tips: [
      { en: 'Remove shoes at the front door before stepping inside.',
        ru: 'Снимайте обувь у входной двери, прежде чем войти.' },
      { en: 'Guest slippers (тапочки / tapochki) are usually provided — accept them.',
        ru: 'Гостям обычно дают тапочки — принимайте их.' },
      { en: 'Never walk on carpets or cushioned floor areas with outdoor footwear.',
        ru: 'Никогда не ходите в уличной обуви по коврам и мягким зонам для сидения.' },
      { en: 'Place your shoes neatly to the side — not blocking the entrance.',
        ru: 'Ставьте обувь аккуратно сбоку, не загораживая вход.' },
    ],
    phrase: { label: 'Remember', en: 'Shoes off = You belong here 🏠', ru: 'Снял обувь = Добро пожаловать 🏠' },
  },
  {
    id:       'bazaar',
    emoji:    '🛒',
    ...
    title:  { en: 'Bazaar Bargaining',  ru: 'Торг на базаре' },
    intro:  { en: 'Bargaining is expected and welcomed at Kyrgyz markets — it is a social interaction, not a conflict.',
              ru: 'Торговаться на кыргызских рынках — норма и приветствуется; это общение, а не конфликт.' },
    tips: [
      { en: 'Start by offering 50–60% of the asking price, then negotiate up gradually.',
        ru: 'Начинайте с 50–60% от цены продавца и постепенно поднимайтесь.' },
      { en: 'Smile and stay friendly — bargaining is a game, not a fight.',
        ru: 'Улыбайтесь и будьте дружелюбны — торг это игра, а не спор.' },
      { en: 'Accept tea, fruit or a chat if a vendor offers — it\'s hospitality, not a trick.',
        ru: 'Принимайте чай, фрукты или разговор, которые предлагает продавец — это гостеприимство.' },
      { en: 'The Osh Bazaar (Ошский рынок) is Bishkek\'s largest market — go with small bills.',
        ru: 'Ошский рынок — крупнейший рынок Бишкека; берите с собой мелкие купюры.' },
    ],
    phrase: { label: 'Key phrase', en: '"Kancha?" — How much?', ru: '"Канча?" — Сколько стоит?' },
  },
  {
    id:       'tea',
    emoji:    '🫖',
    ...
    title:  { en: 'Tea Culture',          ru: 'Чайная культура' },
    intro:  { en: 'Tea (chai) is the heart of Kyrgyz hospitality — accepting tea is accepting friendship.',
              ru: 'Чай (чай) — основа кыргызского гостеприимства; принять чай значит принять дружбу.' },
    tips: [
      { en: 'You will always be offered tea when visiting a home — refusing is impolite.',
        ru: 'Вам всегда предложат чай в гостях — отказаться считается невежливым.' },
      { en: 'Hold the bowl or cup with both hands as a sign of respect.',
        ru: 'Держите пиалу или чашку обеими руками — это знак уважения.' },
      { en: 'The host refills your cup often — place your hand over the rim when you\'ve had enough.',
        ru: 'Хозяин часто подливает чай — положите руку на чашку, когда вам достаточно.' },
      { en: 'Black tea with milk (кара чай / kara chai) and green tea are most common.',
        ru: 'Чёрный чай с молоком (кара чай) и зелёный чай — самые распространённые.' },
    ],
    phrase: { label: 'Key phrase', en: '"Chai ichelis!" — Let\'s drink tea!', ru: '"Чай ичели!" — Давайте пить чай!' },
  },
  {
    id:       'dining',
    emoji:    '🍽️',
